...
Finally, use 'python3 memory_expansion_tool02.py' to run the script. If the dependencies were installed in venv, may need 'source myenv/bin/activate;' first. The script will show its progress on the command line, and it may take a while depending on how many questions she has in your particular set of memory for her.
