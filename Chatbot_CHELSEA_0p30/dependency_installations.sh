...
# ! Refer to this line in 'chelsea_class.py', need to change '/YOUR_DIRECTORY_HERE/' to your correct path:
#self.MODEL_PATH = "/YOUR_DIRECTORY_HERE/.local/share/piper-tts/piper-voices/en_US-amy-low.onnx"
# ! Also change '[DOWNLOAD PATH]' here to the correct path that you downloaded the voice files to!
